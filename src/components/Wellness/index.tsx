...
const Wellness = () => {
    ...
    return (
        <main className='w-full flex flex-col gap-4'>
            ...
            <div className='flex flex-col items-center lg:px-24 px-4 py-8'>
                <div className='flex lg:flex-row flex-col items-start lg:gap-12 gap-4 w-full'>
                    <div className='lg:w-[300px] w-full h-[350px]'>
                        <Image 
                    ...
                    <div className='flex flex-col lg:w-4/5 w-full'>
                        <h1 className='font-semibold lg:text-4xl text-2xl tracking-wide'>Mr. Krishna Dahal</h1>
                        <h2 className='font-semibold lg:text-2xl text-lg tracking-wide text-primary mt-4'>Overview</h2>
            ...
            <div className='w-full lg:px-24 px-4'>
                ...
                <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-8 gap-4 w-full mt-8'>
